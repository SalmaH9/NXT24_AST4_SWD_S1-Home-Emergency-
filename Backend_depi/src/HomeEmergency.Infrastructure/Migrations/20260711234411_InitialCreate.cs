        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserWarnings_Users_IssuedBy",
                        column: x => x.IssuedBy,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("8b72f1a3-2c1a-4fde-b56e-8d827f3d4e8c"), null, "Provider", "PROVIDER" },
                    { new Guid("d6e8a5b2-32a1-43e9-98fd-8b3f6f1c4e72"), null, "Admin", "ADMIN" },
                    { new Guid("e3d8f1e5-6b8c-4a3d-be9d-7f8e9a2b3c4d"), null, "Company", "COMPANY" },
                    { new Guid("f2c8d5a1-7b3e-4c28-9844-42ea9e1a1234"), null, "Customer", "CUSTOMER" }
                });
